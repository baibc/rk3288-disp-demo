...
int main(int argc, char **argv)
{
		...
		//vinfo4.xres =1024;
		//vinfo4.yres =768;
		//vinfo4.xres_virtual =1024;
		//vinfo4.yres_virtual =768;
		xpos4 =0; 
		ypos4 =0;
		...
		//int win_rb_flag =0;
		/* ################################################################# */ //main function
		do{ /* set parameter for fb1 and fb4 */
			//ioctl(fb_fd1, RK_FBIOPUT_RB_COLOR, &win_rb_flag);
		...
		/* ----------------------------------------------------- */
		//rk_ps_cfg.hwc_position_x_cfg =500;
		//rk_ps_cfg.hwc_position_y_cfg =500;
		...
		for(nihao=0; nihao<1024; nihao=nihao+10)
		{
			...
			rk_us_cfg.hwc_pos_x_cfg =nihao;
			rk_us_cfg.hwc_pos_y_cfg =736/2;
